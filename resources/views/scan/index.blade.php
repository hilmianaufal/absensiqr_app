...
<div class="d-flex align-items-center justify-content-between mb-3">
  <div>
    <h4 class="fw-bold mb-0">Scan QR Santri</h4>
...
@if($activePrayer)
  <div class="alert alert-success d-flex justify-content-between align-items-center">
    <div>
      <div class="fw-bold">Sholat Aktif: {{ $activePrayer->name }}</div>
      <div class="small">
        Window: {{ $activePrayer->start_time }}–{{ $activePrayer->end_time }}
        • Toleransi telat: {{ $activePrayer->late_minutes }} menit
      </div>
    </div>
...
@else
  <div class="alert alert-warning">
    <div class="fw-bold">Tidak ada sholat aktif</div>
...
document.addEventListener('DOMContentLoaded', () => {
          ...
          resultBox.innerHTML = `
            <div class="d-flex justify-content-between align-items-start gap-2">
              <div>
                ...
                <div class="small mt-2">Sholat: <b>${json.prayer}</b> • Jam: <b>${json.scanned_at}</b></div>
              </div>
              <div class="text-end">
                ${badge}<br/>
  ...
  if (!hasActivePrayer) {
    ...
    showAlert('warning', 'Tidak ada sholat aktif. Tombol scan dimatikan.');
  } else {
    enableCameraMode();
  }
});
